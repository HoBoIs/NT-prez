		...
		switch (_p0.ctor) {
			case 'WSData':
				...
				return A2(_elm_lang$core$String$startsWith, 'SONGS:', _p1) ? A2(
					...
					{ctor: '[]'}) : (A2(_elm_lang$core$String$startsWith, 'PRFL:', _p1) ? A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							prev_first_line: A2(_elm_lang$core$String$dropLeft, 5, _p1)
						}),
					{ctor: '[]'}) : (A2(_elm_lang$core$String$startsWith, 'NXTFL:', _p1) ? A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							nxt_first_line: A2(_elm_lang$core$String$dropLeft, 6, _p1)
						}),
					{ctor: '[]'}) : A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
			...
			case 'PlayMusicAuto':
				return A2(
					...
					{
						ctor: '::',
						_0: A2(_elm_lang$websocket$WebSocket$send, model.wsUrl, 'PLAYMUSICAUTO:'),
						_1: {ctor: '[]'}
					});
			case 'PauseMusic':
				return A2(
					...
					model,
					{
						...
						_0: A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								'CUSTOMTHANKS:',
								A2(_elm_lang$core$Basics_ops['++'], '1', model.name1))),
						_1: {ctor: '[]'}
					});
			case 'NamedThanks2':
				return A2(
					...
					model,
					{
						...
						_0: A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								'CUSTOMTHANKS:',
								A2(_elm_lang$core$Basics_ops['++'], '2', model.name2))),
						_1: {ctor: '[]'}
					});
			default:
				return A2(
							...
							A2(
								...
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										model.pname1,
										A2(_elm_lang$core$Basics_ops['++'], '|', model.pname2))))),
						_1: {ctor: '[]'}
					});
		}
	});
...
var _Isti115$antiochia_presenter$Main$remove_B = function (str) {
	return function (t) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			A2(
				_elm_lang$core$Maybe$withDefault,
				'Error',
				_elm_lang$core$List$head(t)),
			A2(
				_elm_lang$core$Maybe$withDefault,
				'',
				_elm_lang$core$List$head(
					A2(_elm_lang$core$List$drop, 1, t))));
	}(
		A2(_elm_lang$core$String$split, 'ß', str));
};
var _Isti115$antiochia_presenter$Main$has_B = function (str) {
	return A2(_elm_lang$core$String$contains, 'ß', str);
};
var _Isti115$antiochia_presenter$Main$songclassname = function (str) {
	return _Isti115$antiochia_presenter$Main$has_B(str) ? 'songTitle_w' : 'songTitle';
};
var _Isti115$antiochia_presenter$Main$remove_tail = function (str) {
	return A4(
		_elm_lang$core$Regex$replace,
		_elm_lang$core$Regex$All,
...
var _Isti115$antiochia_presenter$Main$remove_comm = function (str) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'Error',
		_elm_lang$core$List$head(
			A2(
				_elm_lang$core$String$split,
				'#',
				_Isti115$antiochia_presenter$Main$remove_tail(str))));
};
var _Isti115$antiochia_presenter$Main$keep_comm = function (str) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		_elm_lang$core$List$head(
...
var _Isti115$antiochia_presenter$Main$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {state: a, wsUrl: b, input: c, songTitles: d, talks: e, musics: f, nxt_first_line: g, prev_first_line: h, name1: i, name2: j, pname1: k, pname2: l};
											};
										};
									};
								};
...
var _Isti115$antiochia_presenter$Main$NewNameP2 = function (a) {
	return {ctor: 'NewNameP2', _0: a};
};
var _Isti115$antiochia_presenter$Main$NewNameP1 = function (a) {
	return {ctor: 'NewNameP1', _0: a};
};
var _Isti115$antiochia_presenter$Main$NewName2 = function (a) {
	return {ctor: 'NewName2', _0: a};
};
var _Isti115$antiochia_presenter$Main$NewName1 = function (a) {
	return {ctor: 'NewName1', _0: a};
};
var _Isti115$antiochia_presenter$Main$NamedThanksPair = {ctor: 'NamedThanksPair'};
var _Isti115$antiochia_presenter$Main$NamedThanks2 = {ctor: 'NamedThanks2'};
var _Isti115$antiochia_presenter$Main$NamedThanks1 = {ctor: 'NamedThanks1'};
...
var _Isti115$antiochia_presenter$Main$PlayMusicAuto = {ctor: 'PlayMusicAuto'};
						...
						},
						{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(model.prev_first_line),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
							...
							},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(model.nxt_first_line),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
									...
									A2(
												...
												return A2(
													_elm_lang$html$Html$div,
													{
														...
														_0: _elm_lang$html$Html_Attributes$class(
															_Isti115$antiochia_presenter$Main$songclassname(t)),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(
																_Isti115$antiochia_presenter$Main$SendSong(
																	_Isti115$antiochia_presenter$Main$remove_B(t))),
															_1: {ctor: '[]'}
														}
													},
													{
														...
														_0: A2(
															...
															},
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text(
																	_Isti115$antiochia_presenter$Main$keep_comm(
																		_Isti115$antiochia_presenter$Main$remove_B(t))),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html$text(
																_Isti115$antiochia_presenter$Main$remove_comm(
																	_Isti115$antiochia_presenter$Main$remove_B(t))),
															_1: {ctor: '[]'}
														}
													});
												...
												model.songTitles)),
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$id('customThanksMaker'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$id('Thanks1div'),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('Thanksdiv'),
																_1: {ctor: '[]'}
															}
														},
														{
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onClick(_Isti115$antiochia_presenter$Main$NamedThanks1),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$class('ThanksButton'),
																		_1: {ctor: '[]'}
																	}
																},
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Köszönjük...'),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$id('Thanks1inp'),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$value(model.name1),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Events$onInput(_Isti115$antiochia_presenter$Main$NewName1),
																				_1: {ctor: '[]'}
																			}
																		}
																	},
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$id('Thanks2div'),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$class('Thanksdiv'),
																	_1: {ctor: '[]'}
															...
															},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Events$onClick(_Isti115$antiochia_presenter$Main$NamedThanks2),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$class('ThanksButton'),
																			_1: {ctor: '[]'}
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Hála néked...'),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$id('Thanks2inp'),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$value(model.name2),
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$html$Html_Events$onInput(_Isti115$antiochia_presenter$Main$NewName2),
																					_1: {ctor: '[]'}
																				}
																			}
																		},
														...
														_1: {
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$id('ThanksPairDiv'),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$class('Thanksdiv'),
																		_1: {ctor: '[]'}
																...
																},
																{
																	...
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onClick(_Isti115$antiochia_presenter$Main$NamedThanksPair),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$class('ThanksButton'),
																				_1: {ctor: '[]'}
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('Páros köszönjük'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$id('ThanksPinp1'),
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$html$Html_Attributes$value(model.pname1),
																					_1: {
																						ctor: '::',
																						_0: _elm_lang$html$Html_Events$onInput(_Isti115$antiochia_presenter$Main$NewNameP1),
																						_1: {ctor: '[]'}
																					}
																				}
																			},
																		...
																		_1: {
																			...
																			_0: A2(
																				...
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html_Attributes$id('ThanksPinp2'),
																					_1: {
																						ctor: '::',
																						_0: _elm_lang$html$Html_Attributes$value(model.pname2),
																						_1: {
																							ctor: '::',
																							_0: _elm_lang$html$Html_Events$onInput(_Isti115$antiochia_presenter$Main$NewNameP2),
																							_1: {ctor: '[]'}
																						}
																					}
																				},
								...
								_1: {
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_Isti115$antiochia_presenter$Main$PlayMusicAuto),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
