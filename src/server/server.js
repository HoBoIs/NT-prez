...
wss.on('connection', function connection (ws, req) {
  ...
  process.stdout.write(ws+" - " +req+"is connected\n")
  //process.stdout.write(Object.getOwnPropertyNames(ws)+" - " +Object.getOwnPropertyNames(req)+"is connected\n")
}) 
ip= '0.0.0.0';
if (config.server_on){
...
if (config.server_on){
portInUse(config.port, function(returnValue) {
